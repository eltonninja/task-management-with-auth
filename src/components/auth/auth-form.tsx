...
const AuthForm = ({ isSignUp = false }: AuthFormType) => {
  ...
  return (
    <div className="w-[480px] my-20 mx-auto bg-white shadow-md rounded-md p-8">
      <Text component="h2" className="text-2xl text-center font-bold my-8">
      ...
      >
        ...
        <div className="flex justify-center">
          <Button
            type="submit"
            className="w-full py-2 text-white bg-blue-500 hover:bg-blue-600 active:bg-blue-700 transition-colors duration-200 rounded flex justify-center"
          >
            {isSignUp ? "Sign Up" : "Login"}
            {loading && <Spinner />}
          </Button>
